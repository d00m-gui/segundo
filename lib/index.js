 ...
 * Server
 *
 * Host a single Segundo Application.
 *
 */
...
exports.server = function(dirPath, options, callback){
  connect.createServer(
    ...
    middleware.process,
    middleware.fallback
  ).listen(options.port || 8000, callback)
}
 ...
 * Compile
 *
 * Compiles Single Segundo Application.
 *
 */
      ...
      async.eachLimit(results, 72, compileFile, function(err){
        if(err){
          ...
          async.eachLimit(results, 72, copyFile, function(err){
            setup.config['segundo_version'] = pkg.version
...
exports.doBower = function(command){
