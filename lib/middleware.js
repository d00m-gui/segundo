...
exports.notMultihostURL = function(req, rsp, next){
  ...
  if(hostname == "127.0.0.1" || hostname == "localhost"){
    rsp.statusCode = 307
    rsp.setHeader('Location', 'http://none.nu' + port)
    rsp.end("redirecting you to http://none.nu" + port)
...
/**
 * Opens the (optional) segundo.json file and sets the config settings.
 */
